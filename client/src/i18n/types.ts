...
export interface UITranslations {
  ...
  landing: {
    ...
    navPricing: string;
    navSignIn: string;
    heroManagingLabel: string;
    heroManagingRows: string[];
    heroManagingValues: string[];
    heroManagingNote: string;
    ...
    stat3Label: string;
    stat3Desc: string;
    hiwBandHeading: string;
    hiwBandBody: string;
    hiwBandCta: string;
    proFeaturesEyebrow: string;
    proFeaturesHeading: string;
    proFeaturesSub: string;
    proFeaturesCta: string;
    tabCalendar: string;
    tabAlerts: string;
    tabVault: string;
    tabGates: string;
  ...
  howItWorks: {
    ...
    step3Note: string;
    step4Bullets: string[];
    step5AlertRouting: string;
    step5VaultUpload: string;
    step5StaffNote: string;
    step5VaultNote: string;
    step6Bullets: string[];
    faqTitle: string;
    ...
    vaultTax2: string;
    vaultTax3: string;
    vaultCatPermits: string;
    vaultPermits1: string;
    vaultPermits2: string;
    vaultPermits3: string;
    vaultCatBpjs: string;
    vaultBpjs1: string;
    vaultBpjs2: string;
    vaultBpjs3: string;
    ...
    ppOtaValue: string;
    ppOtaSub: string;
    ppEventsLabel: string;
    ppEventsValue: string;
    ppEventsSub: string;
    g0Name: string;
    g0Desc: string;
    g1Name: string;
